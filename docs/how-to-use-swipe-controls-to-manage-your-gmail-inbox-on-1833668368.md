...
(Android Gmail 用户在**设置>通用设置>滑动动作下也可以使用这些功能。**)

可用选项包括:

*   **存档**(默认操作)-存档的邮件可以在“所有邮件”标签中找到。
*   **删除** -将邮件发送到垃圾箱，它将在那里停留 30 天，然后被永久删除。
*   **标记为已读/未读** -滑动一次标记为已读，再次滑动恢复为未读。
*   **移动到** -您可以指定一个特定的位置或收件箱来发送您的信息。
*   暂停 -暂时从你的收件箱中删除一封邮件。你可以在“休眠”标签中找到休眠邮件。

您也可以通过选择**“无”来禁用向左或向右滑动手势**

如果你找不到滑动操作设置，请仔细检查你是否已经更新到最新版本的 Gmail iOS 应用程序，否则很可能还没有更新。(根据谷歌的数据，可能需要长达 15 天的时间才能实现)。