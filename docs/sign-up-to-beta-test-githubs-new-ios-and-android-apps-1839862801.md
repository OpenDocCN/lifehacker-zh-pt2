...
显然，与桌面版 GitHub 相比，你的智能手机屏幕更小意味着移动应用程序体验将受到限制。根据 Tech Crunch 的说法，这款应用可以让你参与讨论，审查代码(尽管这仅限于几行代码)，合并修改。

虽然就功能而言，iOS 和 Android 应用应该是相同的，但在手机和平板电脑上使用该应用肯定是有区别的。由于 iPad 的屏幕更大，用户将能够在应用程序中查看更多的内容和审查更多的代码。如果连接了外部键盘，它还将支持 GitHub 网站的一些键盘快捷键。否则，智能手机应用程序的局限性也存在于 iPad(和其他平板电脑)上。