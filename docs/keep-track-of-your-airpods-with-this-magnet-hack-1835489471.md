...
这需要一点小技巧，但是非常简单。首先，最好把两个 AirPods 都贴在正面，就像这样:

你再也不用翻垃圾了。

把磁铁放在你的 MacBook 外壳中的简单原因是，当它合上时，它保持闭合；同样，AirPods 和 case 都内置了磁铁，可以在充电时将花蕾保持在适当的位置。

别担心，这不会对你的笔记本电脑造成任何伤害。AirPods 里的磁铁比较弱；如果你有一个非常强的磁铁，你只会把你的笔记本电脑置于危险之中，即使这样，它也可能只会导致你的 [MacBook](https://support.apple.com/en-us/HT203315) 在最糟糕的情况下睡着。
