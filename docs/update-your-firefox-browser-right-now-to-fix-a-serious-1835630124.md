...
该漏洞最初是由谷歌零计划和比特币基地安全公司的成员报告给 Mozilla 的，它允许黑客使用操纵的 javascript 代码来欺骗用户访问在他们的个人电脑上部署恶意代码的网站。这是一个严重的漏洞，Mozilla 安全委员会敦促所有用户立即安装更新——糟糕的是，美国网络安全和基础设施安全局 甚至参与了补丁的传播。

火狐可能是目前最受关注安全和隐私的用户欢迎的主流网络浏览器之一 ，但是很明显，即使是它也会屈服于不可预见的攻击。安装上述补丁，并确保你的火狐用户也这样做。