...
如果你是那 150 万下载应用程序的人之一，你应该现在就从你的设备上卸载它们。

除了广告软件的问题，这些应用程序还会要求一些不必要的权限，这可能会让它们做更多恶意的事情，而不仅仅是为你提供广告。

具体来说，这些应用程序已经请求允许录制音频，并随时收听设备周围的任何内容。这两款应用都使用了一种工具来防止 APK 被打开并被分析。虽然这并不表明这款应用的开发者有恶意，但也不是什么好事。

这条新闻也是一个很好的提醒，确保你在安装应用程序之前，注意它在你的手机上要求什么权限。如果有东西要求访问，而你认为它并不需要，那么你可能首先要重新考虑安装一个应用。