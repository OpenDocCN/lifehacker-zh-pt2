...
正如一位 Redditor [注明的](https://www.reddit.com/r/lifehacks/comments/delfva/want_free_software_never_search_free_you_often/f2xg06l/) :

> “这真的发生在我身上了。找到一个“免费”的简历制作网站。我花了一个小时构建它，当我完成时，你甚至需要付费试用才能下载。”

相反，你*想要*搜索的是“开源”加上你试图寻找的任何应用或服务的一般主题。这不会*总是*让你免费得到一个应用，但是你可能会有更好的运气。你也可以搜索传统应用的“替代品”，做一些你不想付费的事情(或者查看 [类似名称的网站](https://alternativeto.net/) )。

如果你愿意，你可以试试我最喜欢的搜索:“[应用名称]替代网站:reddit.com”，这肯定会给你带来一些很棒的推荐(如果你不介意浏览评论的话)。