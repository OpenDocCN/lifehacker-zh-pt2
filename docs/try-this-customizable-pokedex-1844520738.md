...
但是任何旧的魔法都不行。前 Lifehacker 专栏作家亚当·达奇斯(Adam Dachis)认为，人们可能想要自己的*可定制* Pokédex，他没有错。当然，你可以在 [官方 Pokédex](https://www.pokemon.com/us/pokedex) 上查找任何你想要的神奇宝贝，但是你能控制体验的外观和感觉吗？不，你没有。我们应该得到更好的。于是达奇斯 [在 Airtable](https://airtable.com/universe/expBnjEvgt28vYKbG/the-airtable-pokedex) 上做了一个底座，任何人都可以复制定制。
 ...
 [https://lifehacker.com/embed/inset/iframe?id=twitter-1274024268888788995&autosize=1](https://lifehacker.com/embed/inset/iframe?id=twitter-1274024268888788995&autosize=1) 

他在这里解释了更多的:

> 它的特点是神奇宝贝(包括第八代 Galar 神奇宝贝)、类型、能力、招式、物品等数据。它安装了几个模块，提供了一个类似于神奇宝贝卡片的视觉视图，一个“那个神奇宝贝是谁？”猜谜游戏，以及跨所有表的搜索功能。你可以复制一份，然后随意添加或修改。

你可以探索 [达奇斯的基地](https://airtable.com/universe/expBnjEvgt28vYKbG/the-airtable-pokedex) ，自己制作副本进行定制。你可以使用 Airtable 的免费帐户进行一些基本的定制，但“plus”或“pro”帐户可能会提供其他功能。
