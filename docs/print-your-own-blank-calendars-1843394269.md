...
纸质的组织工具，包括日历和日程表，比电子工具更有优势。你可以准确地跟踪你想要什么，你想要什么，而不需要依赖一个应用程序来为你提供正确的输入字段。你可以享受用你选择的书写工具在一张真实的纸上做标记的具体性(和)。你可以把文件放在你想放的地方——墙上、桌上或活页夹里——而不是把它们拴在你整天盯着的同一个小屏幕上。