...
新的光标设置在新的 iPad Pro 和部分 iPad(第五代或更高版本)、iPad minis(第四代或更高版本)和 iPad Air 型号(第二代或更高版本)上可用，但您需要首先安装 iPadOS 13.4。如果您还没有安装更新，请前往**设置>常规>软件更新**安装更新。

从那里，通过蓝牙(如果适用)将鼠标或触控板连接到 iPad，或将相关的加密狗直接插入 iPad。您的光标应该会立即出现——不需要像过去那样修改可访问性设置。

### 如何自定义 iPad 光标

要自定义光标，请进入**设置>辅助功能>指针控制**。从这里，您可以使用以下菜单来修改光标的外观:

*   向下滚动到**“指针大小”**使光标变大或变小，并使用**颜色**菜单改变其外观。
*   访问**“滚动速度”**调整移动/触摸鼠标/触控板时光标移动的速度，并更改“缩放平移”行为。

如果你需要调整你的触控板——例如，它的跟踪速度，或者你是否想启用“轻触点击”或双指辅助点击——你可以直接在**设置>通用>触控板中找到这些选项。**