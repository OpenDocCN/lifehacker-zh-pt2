...
据[【MattressExpert.com](https://themattressexpert.com/)的创始人彼得·坎塞利称，这个建议在处理对你的床垫来说可能有点太小的床单时特别有效(而且需要更多的努力)。

也要寻找合适床单的标签。如果你正对着床，带标签的角通常是为了贴合床垫右下方的。从这里，您可以找到它的对角，并在两端安装板材。
