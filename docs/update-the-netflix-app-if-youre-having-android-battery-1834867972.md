...
事实证明，从去年 4 月到 12 月，许多用户都报告了类似的问题。

这个问题似乎只影响运行 Android 6.0.1 的设备，但仍有 17%的 Android 用户。

幸运的是，这个问题有一个简单的解决方案:更新你的应用。网飞应用程序的最新版本 7.8.0 纠正了这个问题，所以如果你有问题，那么最好和最简单的解决方案是 jsut 下载修复。