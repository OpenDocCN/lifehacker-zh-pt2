...
最近的数据表明，尽管微软、主要安全公司、美国政府和几乎所有科技出版物一再敦促，仍有超过 70 万台易受攻击的 PC 没有安装必要的更新。但是最初是针对假设的 BlueKeep 攻击的预防措施，现在是防御真正攻击的唯一方法。

所以，说真的:停止忽视警告，尽快安装安全补丁修复 Windows 7 RDP 漏洞——如果可能的话，现在就*修复。使用 Windows Server 2008、Windows Server 2008 R2 和企业版 Windows 7 的企业也是如此。从微软官方更新页面 可以很容易地 [下载并安装针对您的 Windows 版本的特定安全补丁。](https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/CVE-2019-0708)*