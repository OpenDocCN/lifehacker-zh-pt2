...
### [谷歌遇见网格视图](https://chrome.google.com/webstore/detail/google-meet-grid-view/bjkegbgpfgpikgkfidhcihhiflbjgfic)

如果你不想等待谷歌推出 Google Meet 的“网格视图”,那就自己使用这个 Chrome 扩展来获得一个。考虑到谷歌一直在应对的所有变化，这个扩展可能某一天还能工作，第二天就被搞糟了。

作为替代，你也可以试试这个*其他*[**Google Meet Grid View**](https://chrome.google.com/webstore/detail/google-meet-grid-view/kklailfgofogmmdlhgmjgenehkjoioip)**扩展，大概会比上面链接的更新更多。(如果你需要 Firefox 或 Edge 的扩展，你也可以在这里找到那些。)**

### **[点头——对谷歌见面的反应](https://chrome.google.com/webstore/detail/nod-reactions-for-google/oikgofeboedgfkaacpfepbfmgdalabej)**

**这个名字已经说明了一切，不是吗？使用 [**Nod**](https://chrome.google.com/webstore/detail/nod-reactions-for-google/oikgofeboedgfkaacpfepbfmgdalabej) 分机，你就能让会议中的其他人对他们正在做的任何事情做出快速反应——省去你不得不取消麦克风的静音并等待谈话间歇插入你的简洁评论的不便。一个警告:确保 Google Meet 聊天中的每个人都安装了这个扩展，否则你会反应迟钝。**

### **[迎接出勤](https://chrome.google.com/webstore/detail/meet-attendance/nenibigflkdikhamlnekfppbganmojlg)**

**无论你是老板还是超负荷工作的老师，你都可以使用 [**Meet 考勤**](https://chrome.google.com/webstore/detail/meet-attendance/nenibigflkdikhamlnekfppbganmojlg) 来追踪谁参加了你的会议。如果你每周和你的朋友们开一次会议，那就不太实际了，但是如果你试图管理一个组织或者一群六岁的孩子——有时感觉是一样的——这个扩展会有所帮助！(这里的 [也是这个应用的概念的一个火狐版本](https://addons.mozilla.org/en-US/firefox/addon/google-meet-attendance/?src=search) 。)**
