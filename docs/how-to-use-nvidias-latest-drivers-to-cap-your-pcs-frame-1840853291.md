...
你也可以使用 Nvidia 的网站 [直接下载最新的驱动](https://www.nvidia.com/Download/index.aspx)—版本 441.87，截止到我们写这篇文章的时候。

一旦你安装了新的驱动程序，右键点击你的桌面并选择该选项，弹出你的 Nvidia 控制面板。然后你会想点击“管理 3D 设置”并向下滚动一点，直到你看到新的“最大帧率”选项。点击它，弹出一个小滑块:

您应该将该值设置为什么？我建议从匹配你的显示器的刷新率开始，如果你想启用它的话。当然，如果你只是让画面无上限地飞行，你会享受到 [更少的输入延迟](https://www.blurbusters.com/faq/benefits-of-frame-rate-above-refresh-rate/) ，但普通人可能会注意到随之而来的图像撕裂，而不是他们在*堡垒之夜*拍摄朋友时能够察觉到的毫秒差异。

此外，如果你在笔记本电脑上玩游戏，限制你的帧速率可以确保你的显卡不会拼命工作——产生不必要的噪音和热量，烧坏你的电池——产生额外的帧，这些帧可能会给你的游戏带来撕裂或其他烦恼。
