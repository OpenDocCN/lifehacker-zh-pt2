...
值得称赞的是，这更多的是支持这些功能的技术——蓝牙 LE——的问题，而不是隔空投送本身的任何漏洞。有几种方法可以解决这个问题，正如 [Hexway](https://hexway.io/blog/apple-bleee/) 在一篇博文中提到的:

> 这种行为与其说是脆弱性，不如说是生态系统工作的一个特征。我们在从 10.3.1 开始的 iOS 版本(包括 iOS 13 beta)中检测到了这种行为。
> 
> *不幸的是，你唯一能做的就是关闭设备上的蓝牙。但我们也注意到，旧设备(像 iPhone 6s 之前的所有设备一样)不会连续发送 BLE 消息，即使它们已经更新了操作系统版本。它们只发送有限数量的信息(例如当你导航到 Wi-Fi 设置菜单时),可能苹果这样做是为了节省旧设备的电池电量。”*

如果你没有任何连接到手机的外部设备，比如一副无线耳机或 Apple Watch，这是一个很好的建议。然而，如果你这样做了，那么你可能会想让蓝牙开着，即使这样做意味着有人可以很容易地获取你的“电话状态，Wi-Fi 状态，缓冲区可用性，操作系统版本，等等”，正如 Hexaway 所描述的。
