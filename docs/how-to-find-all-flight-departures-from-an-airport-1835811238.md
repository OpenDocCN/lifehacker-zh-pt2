...
如果你想有机会查看所有当地出发的航班，试试使用[【FlightsFrom.com】](https://www.flightsfrom.com)——一个汇集了从世界各地出发的直飞航班的网站。通过选择一个机场，你可以查看某一天(以及从现在起的九个月内)从那里出发的所有航班；正如本周的 [推荐简讯](https://www.recomendo.com/) 中所推荐的，当从依赖地区航空公司的不知名目的地订票时，这尤其有用。

例如，使用 FlightsFrom.com 来查找从瑞典哈格福斯出发的机票，会出现两个结果是 7 月 1 日出发的地区航空公司；与此同时，在谷歌上搜索同一天的航班，结果是空的。

它吸引人的部分原因是它只是让旅行更容易计划；你可以在列表中看到所有直达航班的起飞时间，而且没有赞助商广告。如果你想在一天中的某个特定时间出发，但没有目的地，FlightsFrom.com 也是一个有用的工具，因为它根据出发时间组织了整个列表。

另一方面，尽管很有帮助，FlightsFrom.com*并没有考虑票价定价。所以，一定要将你的搜索结果与你在其他网站上找到的结果进行比较。([)Skyscanner](https://www.skyscanner.com/)是另一个很好的资源，虽然他们有广告。)* 
