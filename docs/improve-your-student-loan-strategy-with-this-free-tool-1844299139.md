...
*   **如何找到最佳还款策略:**贷款模拟器可能会推荐另一个方案，或者建议贷款合并。你可以看看如何降低你的付款或更快还清贷款的方法。
*   **如果你在支付方面遇到困难，该怎么办:**该工具可以帮助你找出哪个选项更好——暂停或降低你的月支付额。你可以权衡每个选择的利弊，学习如何避免学生贷款违约。
*   **模拟借更多的钱(即将推出！)L** 如果你需要借更多，这个工具可以显示它将如何影响你的情况。你也可以看到联邦贷款限额和你的学校如何影响费用。

教育部在六月份发布了一个 [的简短视频](https://www.youtube.com/watch?time_continue=76&v=k81nkuwUwEM&feature=emb_title) 调侃了一些功能。

贷款模拟器基于几个假设进行估算。这些可能包括你的详细资料，你的学生贷款和还款。你可以在这里 看到每一个假设 [的深入解释。

虽然 Loan Simulator 功能强大，但该工具也有其局限性。付款估计取决于您提供的信息。请记住，每个学生贷款场景都是独特的，贷款模拟器无法提供量身定制的财务建议。

如有反馈，教育局恳请分享。您可以在此处](https://studentaid.gov/loan-simulator/repayment/results/plan/(resultsPanel:assumptions-panel//infoPanel:contact-us-panel)) 提问、提出建议或请求新增贷款模拟器功能 [。](https://studentaid.gov/feedback-ombudsman/)