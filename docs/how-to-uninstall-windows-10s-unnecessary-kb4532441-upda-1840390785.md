...
如果你安装了 Autopilot 更新，但不是 Autopilot 用户，那么你可以简单地忽略它——微软表示它不会对你的设备造成任何不利影响。也就是说，我附和 [Techradar](https://www.techradar.com/news/microsoft-once-again-sends-out-the-wrong-windows-10-update-to-users) 的建议，无论如何都要卸载更新。方法如下:

1.  打开 Windows 10 开始菜单。
2.  单击齿轮形状的设置图标。
3.  在设置窗口，进入**更新&安全>查看更新历史>卸载更新**。
4.  使用搜索框，搜索**“Windows 10 自动驾驶更新 KB4532441。”**
5.  单击选中更新，然后单击列表顶部的**“卸载”**。
6.  点击**“是”**确认卸载。
7.  等待该过程完成，并根据需要重新启动您的电脑。

如果你遇到任何问题，请咨询 [我们更长的卸载最新 Windows 10 更新](https://lifehacker.com/how-to-undo-and-prevent-windows-updates-1836420965) 的操作指南。