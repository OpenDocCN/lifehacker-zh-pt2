...
从设计上来说，这些几率比过去更低。据报道，去年，彩票程序被“调整”以减少头奖支付的频率。2017 年 10 月前，中奖几率为 2.589 亿分之一。但随着越来越少的人赢得大奖，累积奖金不断增长，将我们引向今天的 10 亿美元奖金。

根据 [Mega Millions 网站](https://nylottery.ny.gov/sites/default/files/odds-prizes-pdf/Mega_Millions_Odds_and_Prizes_Print_PDF_082317_v3_0.pdf) 的统计，还有赔率略高的小彩池:

*   **第二名**(五个匹配号码):12607306 中的 1
*   **第三名**(四个与兆球匹配的号码):931001 中的 1
*   **第四名**(四个匹配号码):38792 中的 1
*   **第五名**(兆球三个匹配号码):14547 中 1
*   **第六名**(三个匹配号码):606 中 1
*   **第七名**(兆球两个匹配号码):693 中 1
*   **第八名**(兆球一个匹配号码):89 中 1
*   **第九名**(没有与兆球匹配的号码):37 中 1
