...
如果你使用的是安卓系统，你可以登陆 Google Play 退出测试版，如果你之前参与过的话。从 Google Play 或 App Store 更新 WhatsApp，无论你在黑暗或明亮模式下使用 的什么系统设置，该应用都应该遵循 [。](https://lifehacker.com/how-to-enable-dark-mode-in-ios-and-android-1841770858)

如果你使用的是 Android 9，你需要点击 WhatsApp 右上角的三点图标，然后点击**设置**。点击聊天，你会看到一个新的“主题”列表点击这个按钮，你就可以选择亮暗模式。

*这个故事最初发表于 2020 年 3 月 3 日，2020 年 3 月 27 日更新了一个视频。*