...
一旦你注册并且更新到了 WhatsApp 应用的测试版，就启动它。点击右上角的三点图标，调出您的设置。您应该会在姓名右侧看到一个看起来像二维码的小图标:

点击它，你会看到这个屏幕:

你在盯着你的二维码。当你想与他人分享你的 WhatsApp 详细信息时，请将此功能打开；反过来，他们将点击“扫码”选项来做到这一点。如果你知道二维码是如何工作的，这个应该很简单。如果你有问题，确保代码共享者已经把他们的屏幕亮度调到最大。这通常会解决你在扫描方面可能遇到的任何问题。