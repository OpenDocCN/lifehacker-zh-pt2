...
> 原文:[https://life hacker . com/keep-a-full-charged-phone-power-bank-in-home-1843909062](https://lifehacker.com/keep-a-fully-charged-phone-power-bank-at-home-1843909062)
...
你有多种选择、价格和功能可以考虑。你想要一些超级基本的东西，让你度过一个意想不到的停电，还是一些可以在你停电一整天的时候使用的东西？ [Wirecutter 建议](https://www.nytimes.com/wirecutter/reviews/best-usb-battery-packs/) 寻找额定充电功率至少为 15 瓦的 USB-C 充电器；对于 micro-USB 和 USB-A，8 瓦以上应该是目标。这些瓦特数将确保您的设备尽可能快速高效地充电。就容量而言，你需要计算你可以使用一个电源板给你的设备充电多少次。例如，一部 iPhone 11 的电池容量约为 3，050 mAh，因此一个 10，000 mAh 容量的充电器理论上应该可以给你充满三次电，但实际上， [可能会接近两个](https://www.powerbankguide.com/powerbank-capacity-explained/) ，这取决于你的电源组的性能与其宣传规格的匹配程度。(你可以通过谷歌快速计算出你手机的电池容量。)价格会因品牌、功率容量和重量而异。既然我建议把这个留在家里，我会说越大越好。如果你真的想为紧急情况做好准备，考虑买一个能给你的笔记本电脑充电的电源。这些设备将内置一个常规的交流电源插座，这意味着你可以 [实际上用它们给任何东西充电，只要一个插头能运行高达 60 瓦](https://www.nytimes.com/wirecutter/reviews/the-best-portable-ac-power-supply/) 。

*更新以澄清语言，并更正描述根据手机容量相对于您的电源组容量的预期充电次数部分的错误。*