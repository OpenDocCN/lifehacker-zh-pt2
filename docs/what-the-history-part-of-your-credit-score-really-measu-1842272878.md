...
以 FICO 分数为例，根据 MyFICO 博客的，在计算你的这部分信用分数时，要考虑三个因素:

> 1.  How long has your credit account been open, including the age of your earliest account, the age of your latest account and the average age of all your accounts.
> 2.  How long has the specific credit account been open?
> 3.  How long has the account been used?

贷方不仅想知道你的账户开了多久，他们还想确保你正确地使用了每一个账户。“这实际上是为了给贷款人更多的数据点，以帮助他们做出决定，”舒尔茨说。
...
舒尔茨说，虽然成为别人账户的授权用户可以提高你的分数，但拥有自己名下的账户会产生更大的影响。

如果你关闭了一个你名下有良好付款记录的信用账户，它将在你的报告上保留 10 年。如果你的 [不再是某人的授权用户](https://twocents.lifehacker.com/how-to-close-your-authorized-user-credit-card-without-h-1841158752) ，那段历史马上就消失了。你可能会看到你的分数下降了几个点，但如果你一直在努力建立自己的良好信用，没有授权状态，你的分数不会大幅下降。