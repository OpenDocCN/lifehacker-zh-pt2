...
3.  运行安装文件，然后按照页面上提供的说明配置应用程序。
 ...
 [https://lifehacker.com/embed/inset/iframe?id=twitter-1169307224184885249&autosize=1](https://lifehacker.com/embed/inset/iframe?id=twitter-1169307224184885249&autosize=1) 

一旦安装完毕，你的 Mac 桌面上就会出现一个小小的文件夹。你可以通过点击和拖动在你的桌面上移动他，同时右击并选择“动画！”将循环播放经典的剪辑动画。查看上面 Uenal 的推文，获得快速视频演示。这款应用除此之外没什么作用，但它还是有点怀旧的味道。