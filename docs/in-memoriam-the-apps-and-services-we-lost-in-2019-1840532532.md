...
像往常一样，谷歌今年取消了许多服务，包括一些你实际上听说过的服务，如 Inbox 应用程序和 Google+。Google Hangouts 计划于明年关闭，由于谷歌糟糕的命名方案，很难说它是否会被无缝取代，或者只是破坏每个喜欢在 Gmail 内聊天的人。

Wunderlist 也将在明年消失，因为微软将用户转移到其创造性命名的待办事项应用程序。我试过了，它就像一个稍微丑陋和丑陋的神童。改为切换到 [到](https://todoist.com/) 。
